...
<Steps>
  ...
  <Accordion title="Can I publish a web app onto the dApp Store?">
Yes! With a few additional steps, you can wrap a web app in an Android app and generate an APK for app submission.

For a tutorial and more information, view our [web app publishing guide](/recipes/general/publishing-a-web-app).
