...
description: "This guide will show you how to integrate an Anchor Program into your React Native dApp, using the [Anchor Counter dApp](https://github.com/solana-mobile/tutorial-apps/tree/main/AnchorCounterDapp) as reference."
---
...
<Button href="https://github.com/solana-mobile/tutorial-apps/tree/main/AnchorCounterDapp">
  Example App Repo
</Button>
...
<Button href="https://github.com/solana-mobile/tutorial-apps/blob/main/AnchorCounterDapp/src/components/counter/counter-data-access.tsx#L15">
  See example
</Button>
...
<Button href="https://github.com/solana-mobile/tutorial-apps/blob/main/AnchorCounterDapp/src/components/counter/counter-data-access.tsx#L89">
  See example
</Button>
