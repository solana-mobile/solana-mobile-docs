---
title: "Engaging with Saga Users"
---
...
To better understand how Collection NFTs verify a normal NFT, read the official Metaplex [documentation](https://www.metaplex.com/docs/smart-contracts/token-metadata/collections).
...
Adapter](/get-started/react-native/quickstart) (`authorize` + `signMessage`).
...
Alternatively, there are many third-party and community-created tools to generate a mint list.
