...
Seeker Connect utilizes Mobile Wallet Adapter's extended remote communication protocol over a Nostr relay. Any Nostr relay that supports public access and ephemeral events can be used. Solana Mobile provides a Nostr relay that satifies these requirments and free to use. Use of the Solana Mobile Nostr relay requires agreement to our terms.
