...
<Card
  ...
  icon="wallet"
  href="/solana-mobile-stack/mobile-wallet-adapter"
>
  A universal protocol connecting mobile dApps to wallets.
</Card>

  <Card title="Seeker Connect" icon="link" href="/solana-mobile-stack/seeker-connect">
    Connect directly to a certified device's own wallet.
  </Card>
</Columns>
