...
description: "This tutorial will guide you through the process of building a React Native dApp that sends a message to the Solana network."
sidebarTitle: "Build your first dApp"
---
...
- How to use [**Mobile Wallet Adapter**](/get-started/overview#mobile-wallet-adapter) to connect to an installed wallet app.
...
Read the [prerequisite setup](/get-started/development-setup) guide before starting the tutorial.
You'll need:
...
This tutorial will be using the [fakewallet](/get-started/development-setup#3-install-a-wallet-app) app to test your app's integration with Mobile Wallet Adapter.

## Clone the React Native dApp Scaffold

This dApp will build off the **[React Native Scaffold dApp](/get-started/react-native/setup)** which already has a simple user interface that allows you to connect to a mobile wallet, request an airdrop, and sign transactions.
...
SDK to request [`authorization`](/get-started/react-native/quickstart) from the wallet and receives your wallet account's info, like the public key.
...
```tsx Sign Transaction expandable
...
- [web3.js Javascript SDK reference](https://solana-foundation.github.io/solana-web3.js/)
