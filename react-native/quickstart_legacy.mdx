...
description: "This guide covers basic use cases and teaches you how to use our React Native SDK in your mobile app.
...
- How to use [**Mobile Wallet Adapter**](/get-started/react-native/installation) to:
  - Connect to a wallet app with `transact`.
  - Request wallet authorization and reauthorization.
  - Sign transactions and messages
- How to use [**web3.js**](https://solana-foundation.github.io/solana-web3.js/) to:
  - Connect to a Solana RPC endpoint.
  - Construct a Solana transaction for signing.

## Install libraries and polyfills

Follow [React Native Setup](/get-started/react-native/installation) or [Expo Setup](/react-native/expo#step-2-install-dependencies) to install dependencies and polyfills.
...
<Button href="/get-started/react-native/mobile-wallet-adapter#web3mobilewalletauthorize">
  API Reference
</Button>
...
<Button href="/get-started/react-native/mobile-wallet-adapter#web3mobilewalletreauthorize">
  API Reference
</Button>
...
<Button href="/get-started/react-native/mobile-wallet-adapter#web3mobilewalletdeauthorize">
  API Reference
</Button>
...
<Tab value="legacyTransaction" label="Legacy Transactions">
...
<Button href="/get-started/react-native/mobile-wallet-adapter#web3mobilewalletsigntransactions">
  API Reference
</Button>
...
<Button href="/get-started/react-native/mobile-wallet-adapter#web3mobilewalletsignmessages">
  API Reference
</Button>
...
<CodeGroup>
```tsx VersionedTransactions expandable
import { transact } from "@solana-mobile/mobile-wallet-adapter-protocol-web3js";
import {
  sendTransaction,
  clusterApiUrl,
...
const connection = new Connection(clusterApiUrl("devnet"), "confirmed");
const signedTx: VersionedTransaction = await transact((wallet) => {/* ...signing code from above... */});
...
```tsx LegacyTransactions expandable
import { transact } from "@solana-mobile/mobile-wallet-adapter-protocol-web3js";
import {
  sendTransaction,
  clusterApiUrl,
...
<Button href="/get-started/react-native/mobile-wallet-adapter#web3mobilewalletsignandsendtransactions">
  API Reference
</Button>
...
<CodeGroup>
```tsx Versioned Transactions expandable
import { transact } from "@solana-mobile/mobile-wallet-adapter-protocol-web3js";
import {
  sendTransaction,
  clusterApiUrl,
...
/_ ...transaction code from above... _/
...
- Follow the [First dApp Tutorial](/react-native/first_app_tutorial) to learn how to use our starter dApp scaffold, create UI components, and record a public message on the Solana Blockchain.
