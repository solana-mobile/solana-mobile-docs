---
title: "Metaplex Integration Guide"
description: "[**Metaplex**](https://www.metaplex.com/docs) provides a collection of on-chain tools/programs for creating and managing NFTs on Solana. In addition, Metaplex provides multiple [Client SDKs](https://www.metaplex.com/docs/dev-tools) that makes it easier for developers to interact and use their on chain programs."
---
...
This guide will focus on integrating with the [Metaplex JS SDK](https://github.com/metaplex-foundation/js) in a React Native app with Mobile Wallet Adapter.
