...
An array of one or more transactions to sign and send. The transaction are of type `Transaction` or `VersionedTransaction` from the [web3.js library](https://solana-foundation.github.io/solana-web3.js/).
...
An array of one or more transactions to sign. The transaction are of type `Transaction` or `VersionedTransaction` from the [web3.js library](https://solana-foundation.github.io/solana-web3.js/).
