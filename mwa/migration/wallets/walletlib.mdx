...
- `signInPayload`: An object containing the payload portion of a [Sign In With Solana message](https://github.com/phantom/sign-in-with-solana).
...
An optional object containing the payload portion of a [Sign In With Solana message](https://github.com/phantom/sign-in-with-solana).
