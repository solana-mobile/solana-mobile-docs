---
title: "Solana Saga December 2023 Update (TKQ1.221220.548) Release Notes"
sidebarTitle: "December 2023 Update"
description: "This update includes changes from the MR2 update (TKQ1.221220.499) through to the current update (TKQ1.221220.548). The on-device changelog for this update is provided below."
---
...
<Note>
  **NOTE: These images are not compatible with Saga dev kits (a.k.a. DVT-1).
  Flashing this image to a Saga dev kit will result in a non-functional and
  non-recoverable device.**
</Note>
