---
title: "Using Mobile Wallet Adapter"
...
- Browse or clone the [MintyFresh repo](https://github.com/solana-mobile/Minty-fresh) to reference best practices for a live, published Kotlin Solana dApp.
