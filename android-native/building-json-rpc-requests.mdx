---
title: "Deep dive: Building JSON RPC request methods"
description: "This deep dive explains how to use underlying primitives in the `rpc-core` library to construct RPC requests for any methods that aren't provided by `SolanaRpcClient`."
---
