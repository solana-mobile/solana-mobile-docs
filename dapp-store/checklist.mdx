...
description: "This checklist aims to provide you a high level overview of the dApp publishing process. You can get an idea of the resources you'll need to prepare before submitting your app."
...
- If you have a web app, follow [this guide](/recipes/general/publishing-a-web-app) to wrap it in an Android app and generate an APK for submission.
...
Once you are ready for publishing, you can follow the step-by-step [App Submission guide](/dapp-store/submit-new-app) to submit your app. The publishing process
