---
title: "Publishing a Progressive Web App (PWA)"
sidebarTitle: "Convert a PWA to an APK"
---
...
<Steps>
<Step>
Generate the SHA256 fingerprint from the Keystore:
...
<Step>
Generate the DAL `assetlinks.json` file:
...
<Step>
Publish the generated `assetlinks.json` file at:
...
**Follow the step by step [dApp publishing guide](/dapp-store/submit-new-app) to submit your signed release APK.**
