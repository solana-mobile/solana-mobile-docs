...
<Note>
  ArDrive uploads are paid from a storage balance, shown by the cost estimator
  next to the estimated cost. If the remaining balance would go negative, use
  **Top Up Balance** to fund it before submitting. AWS S3 uploads go to your own
  bucket and have no balance to top up.
</Note>
