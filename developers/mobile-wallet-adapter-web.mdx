---
title: "Mobile Wallet Adapter on Web Browsers"
description: "The Solana Mobile Stack was designed to be compatible on the mobile web. This document will explain how to ensure a mobile web app can be integrated with Solana Mobile libraries."
---
...
Mobile Wallet Adapter is not supported on iOS Safari. This is the same with iOS native apps, and is a limitation of the operating system explained more in-depth in this [guide](/recipes/mobile-wallet-adapter/wallet-signing-on-ios#why-mwa-is-unavailable-on-ios).
